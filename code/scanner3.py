...
for ticker in tickers:
    try:
        ...
        if price - m150 < 0:
            ...
            is_near_150 = abs(price - m150) / m150 < 0.04

        # Proximity Logic (Is price within 2% of the 50d MA?)
        if price - m50 < 0:
            is_near_50 = abs(price - m50) / m50 < 0.01
        else:
            is_near_50 = abs(price - m50) / m50 < 0.02
        ...
        heavy_buying = (averageVolume10days > averageVolume * 1.2) and (price >  h['Close'].iloc[-1] )
        name = ticker
        ...
        is_near_ma = is_near_150 or is_near_50
        # If it meets core buy criteria, add to results
        buy_candidate = targetMeanPrice > currentPrice and  volume > 250000 and trend_alignment and heavy_buying and near52week and  is_near_ma and slope and trending_up_sharply
        #
        #
        if buy_candidate:
